...
import 'package:project_code/components/map/map_full.dart'; //คอมโพเนนต์สำหรับแสดงแผนที่เต็มหน้าจอ.
...
class Map_View extends StatefulWidget {
  const Map_View({super.key}); // รับ key จาก Parent
      ...
      floatingActionButton: SpeedDial(
        ...
        children: [
          ...
          SpeedDialChild(
            ...
            label: 'แผนที่เต็มหน้าจอ',
            labelBackgroundColor: Colors.white,
            labelStyle: TextStyle(color: Colors.orange, fontSize: 16),
            onTap: () => Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => Map_Fullscreen(),
              ),
            ),
          ),
        ],
